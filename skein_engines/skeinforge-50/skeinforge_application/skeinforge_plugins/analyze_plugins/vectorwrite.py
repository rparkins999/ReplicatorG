...
class VectorwriteRepository:
	...
	def __init__(self):
		...
		self.openWikiManualHelpPage = settings.HelpPage().getOpenFromDocumentationSubName('skeinforge_application.skeinforge_plugins.analyze_plugins.vectorwrite.html')
